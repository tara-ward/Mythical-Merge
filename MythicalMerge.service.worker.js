...
/** @type {string} */
const CACHE_VERSION = '1749962193|6176645080';
/** @type {string} */
const CACHE_PREFIX = 'Mythical Merge-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'MythicalMerge.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["MythicalMerge.html","MythicalMerge.js","MythicalMerge.offline.html","MythicalMerge.icon.png","MythicalMerge.apple-touch-icon.png","MythicalMerge.audio.worklet.js","MythicalMerge.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["MythicalMerge.wasm","MythicalMerge.pck"];
